...
export default function AboutUs() {
  ...
  return (
    <div className="about">
      ...
      <br />
      <section>
        <div style={{backgroundImage: "url('http://localhost:1000/static/images/about-i.webp')", backgroundPositionY: scrollY*0.2 - 300}} className="image"></div>
        <div className="text">
      ...
      <section>
        ...
        <div style={{backgroundImage: "url('http://localhost:1000/static/images/about-ii.webp')", backgroundPositionY: scrollY*0.2 - 300}} alt="" className="image" />
      </section>
      <section>
        <div style={{backgroundImage: "url('http://localhost:1000/static/images/about-iii.webp')", backgroundPositionY: scrollY*0.2 - 300}} alt="" className="image" />
        <div className="text">
